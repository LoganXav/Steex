    ...
    <div className="flex flex-col lg:flex-row gap-5 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-2 gap-5 flex-1">
            ...
            <Paper className="col-span-1 md:col-span-2 p-4">
              <div className="flex justify-between items-center mb-5">
                ...
                <Typography component={Link} to={RouteEnum.COURSES_CATEGORIES} className="text-mui-primary-tertiary hover:text-mui-primary-main">
                  View All
                </Typography>
              </div>
          ...
          <Paper className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 h-[25rem] pb-4">
            <div className="pb-4 h-full overflow-hidden">
              <div className="w-full flex justify-between items-center p-4">
                ...
                <Typography component={Link} to={RouteEnum.INSTRUCTORS} className="text-mui-primary-tertiary hover:text-mui-primary-main">
                  View All
                </Typography>
              </div>
      ...
      <Paper className="w-full lg:w-1/4 p-4">
        ...
        <div className="flex flex-col text-center items-center gap-1 mb-6">
          ...
          <Typography className="text-mui-primary-tertiary">Web Engineer</Typography>
        </div>
